...
<h3>회원가입<small>1단계(필수정보 입력)</small></h3>
<form action="/signup" method="post" autocomplete="off" onsubmit="return valid_form();">
  <div class="form-group">
    <label for="id">아이디</label>
    <input type="text" class="form-control" placeholder="사용할 아이디" id="userId" name="userId">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" placeholder="사용할 비밀번호" id="userPass" name="userPass">
  </div>
   <div class="form-group">
    <label for="pwd_confirm">비밀번호 재확인</label>
    <input type="password" class="form-control" placeholder="비밀번호 재확인" id="pwd_confirm">
  </div>
   <div class="form-group">
    <label for="name">사용자 이름</label>
    <input type="text" class="form-control" placeholder="사용자 이름" id="userName" name="userName">
  </div>
